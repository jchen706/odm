...
class ODM_Stage:
    ...
    def run(self, outputs = {}):
        ...
        log.ODM_INFO('Running %s stage Time Now is %s  in types.py' % (self.name, start_time))
        ...
        log.ODM_INFO('Finished %s stage with time of %s seconds' % (self.name, str(end)))

        log.ODM_INFO('Finished %s stage Time Now is %s   in types.py' % (self.name, system.now_raw()))
