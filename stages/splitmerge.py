    ...
    def process(self, args, outputs):
        ...
        if outputs['large']:
            ...
            if args.merge in ['all', 'pointcloud']:
                log.ODM_INFO("==================================")
                log.ODM_INFO("Merge Point clouds start Current Time is  %s" % str(system.now_raw()))
                log.ODM_INFO("==================================")  
                ...
                log.ODM_INFO("==================================")
                log.ODM_INFO("Merge Point clouds Finish Current Time is  %s" % str(system.now_raw()))
                log.ODM_INFO("==================================")  
            ...
            if not io.file_exists(merged_bounds_file) or self.rerun():
                log.ODM_INFO("==================================")
                log.ODM_INFO("Merge Crop Bounds start Current Time is  %s" % str(system.now_raw()))
                log.ODM_INFO("==================================")
                ...
                log.ODM_INFO("==================================")
                log.ODM_INFO("Merge Crop Bounds Finish Current Time is  %s" % str(system.now_raw()))
                log.ODM_INFO("==================================") 

            # Merge orthophotos
            if args.merge in ['all', 'orthophoto']:
                log.ODM_INFO("==================================")
                log.ODM_INFO("Merge Orthophotos Finish Time is  %s" % str(system.now_raw()))
                log.ODM_INFO("==================================") 
                ...
                log.ODM_INFO("==================================")
                log.ODM_INFO("Merge Orthophotos  Finish Current Time is  %s" % str(system.now_raw()))
                log.ODM_INFO("==================================") 
            ...
            def merge_dems(dem_filename, human_name):
                log.ODM_INFO("==================================")
                log.ODM_INFO("Merge DEMS Start Current Time is  %s" % str(system.now_raw()))
                log.ODM_INFO("==================================") 
                ...
                log.ODM_INFO("==================================")
                log.ODM_INFO("Merge DEMS  Finish Current Time is  %s" % str(system.now_raw()))
                log.ODM_INFO("==================================")
